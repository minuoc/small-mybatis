...
public class SelectKeyGenerator implements KeyGenerator{
    ...
    @Override
    public void processAfter(Executor executor, MappedStatement mappedStatement,Statement stmt, Object parameter) {
        if (!executeBefore) {
            processGeneratedKeys(executor,mappedStatement,parameter);
        }
    }
            ...
            if (parameter != null && keyStatement != null && keyStatement.getKeyProperties() != null) {
                ...
                if(keyProperties != null){
                    ...
                    if (values.size() == 0){
                        ...
                        throw new RuntimeException("SelectKey returned more than one result");
                    } else {
